    ...
    private static long part2() {
        for (int i = 0; i < 100; i++) {
            for (int j = 0; j < 100; j++) {
                ...
                computer.run();
                if (computer.mem[0] == 19690720) return 100 * i + j;
            }
        }
